...
from queens.randomfields.generic_external_random_field import GenericExternalRandomField
...
def create_univariate_random_field(
    ...
    """Create univariate random field.

    A factory for creating univariate random fields.
    ...
    if corrstruct == 'generic_external_random_field':
        ...
        if spatial_dimension == 1:
            ...
            raise ValueError(f'Spatial dimension must be either 1,2, or 3, not {spatial_dimension}')
    else:
        raise RuntimeError(
...
def calculate_one_truncated_realization_of_all_fields(
    ...
    """Compute truncated realizations of random fields.
