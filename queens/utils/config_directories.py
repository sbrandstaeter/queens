...
def logging_directory_on_dask_worker(experiment_directory):
    ...
    Args:
        experiment_directory (Path): Path to directory for data of a specific experiment on the computing machine.
    """
    log_dir = experiment_directory / "dask_workers_logs"
