...
from  pqueens.randomfields.multivariate_random_field_generator import MultiVariateRandomFieldGenerator
...
class TestMultivariateRandomFieldGenerator(unittest.TestCase):
    ...
    def test_constructor(self):
        my_field_generator = MultiVariateRandomFieldGenerator(self.marginal_pdfs,
                                                              self.num_fields,
                                                              self.crosscorr,
                                                              self.dimension,
                                                              self.corrstruct,
        ...
        with self.assertRaises(RuntimeError):
            my_field_generator = MultiVariateRandomFieldGenerator(self.marginal_pdfs,
                                                                  ...
                                                                  self.total_terms)
        with self.assertRaises(RuntimeError):
            my_field_generator = MultiVariateRandomFieldGenerator(self.marginal_pdfs_to_many,
                                                                  self.num_fields,
                                                                  self.crosscorr,
                                                                  self.dimension,
                                                                  self.corrstruct,
