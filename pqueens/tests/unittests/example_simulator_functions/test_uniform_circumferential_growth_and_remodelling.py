...
import pqueens.example_simulator_functions.uniform_circumferential_growth_and_remodelling_radial_displacement as uni_cir_gnr_dr
import pqueens.example_simulator_functions.uniform_circumferential_growth_and_remodelling_radial_displacement_logpdf as uni_cir_gnr_logpdf
...
import pqueens.example_simulator_functions.uniform_circumferential_growth_and_remodelling_radial_strain as uni_cir_gnr_de_r
import pqueens.example_simulator_functions.uniform_circumferential_growth_and_remodelling_stability_margin as uni_cir_gnr_mgnr
import pqueens.example_simulator_functions.uniform_circumferential_growth_and_remodelling_thickness as uni_cir_gnr_thickness
...
def parameter_set(request):
    ...
    Returns "True" for primary parameter and "False" for base parameter set.
    """
...
@pytest.fixture(scope='module')
def matlab_data():
    """ The test data is taken from Christian Cyron's Matlab Code with the same parameters. """
