...
def test_gen_functionality_baci_driver_docker(baci_docker_job, baci_input_file, baci_output_file,
    ...
    # for i in range(len(baci_post_cmds),-1):
    #     mock_run_post_processing.assert_called_with(baci_docker_job['driver_params']['docker_container'],
    #                                                 baci_post_cmds[i], docker_volume_map)
