...
def data_path_fixture(tmp_path):
...
def wrong_data_path_fixture(tmp_path):
    """Create a dummy data path."""
...
def write_dummy_data_fixture(data_path, dummy_data):
...
def write_wrong_dummy_data_fixture(wrong_data_path, dummy_data):
...
def default_data_processor_npy_fixture(data_path):
