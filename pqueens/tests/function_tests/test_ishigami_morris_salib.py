...
#     print(results)
#
#     assert results["sensitivity_indices"]['mu'][0] == pytest.approx(-2.41504207e+01)
#     assert results["sensitivity_indices"]['mu'][1] == pytest.approx(1.26225897e+01)
#     assert results["sensitivity_indices"]['mu'][2] == pytest.approx(-5.70363996e-12)
#
#     assert results["sensitivity_indices"]['mu_star'][0] == pytest.approx(2.41504207e+01)
#     assert results["sensitivity_indices"]['mu_star'][1] == pytest.approx(2.78976691e+01)
#     assert results["sensitivity_indices"]['mu_star'][2] == pytest.approx(5.70363996e-12)
#
#     assert results["sensitivity_indices"]['sigma'][0] == pytest.approx(1.65750124e+01)
#     assert results["sensitivity_indices"]['sigma'][1] == pytest.approx(2.92131768e+01)
...
#     assert results["sensitivity_indices"]['mu_star_conf'][2] == pytest.approx(2.4516069312374997e-12)
