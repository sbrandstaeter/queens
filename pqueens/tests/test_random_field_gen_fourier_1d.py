...
class TestRandomFieldGeneratorFourier1D(unittest.TestCase):
    ...
    def test_values_at_location(self):
        ...
        np.testing.assert_allclose(my_vals,np.array([0.88594784, 1.08872132, 0.88706044, -0.81812818]),1e-07,1e-07)
    ...
    def test_correlation(self):
        ...
        self.assertAlmostEqual(act_corr_at_dist_10[0,1], ref_corr_at_dist_10,
                               7, 'Correlation for distance 10 is not correct.')
        self.assertAlmostEqual(act_corr_at_dist_25[0,1], ref_corr_at_dist_25,
                               7, 'Correlation for distance 25 is not correct.')
        self.assertAlmostEqual(act_corr_at_dist_100[0,1], ref_corr_at_dist_100,
    ...
    def test_marginal_distribution(self):
        ...
        for i in range(200):
            xi = np.random.randn(self.my_stoch_dim,1)
            my_vals[0, i] = self.my_field_generator.evaluate_field_at_location(np.array([30.]), xi)
