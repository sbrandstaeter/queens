...
def test_restart_from_output_folders_baci(
    ...
    output_dir_rel = "../test_baci_morris_salib_" + singularity_bool + "_0"
...
def test_block_restart_baci(
    ...
    those results (with and without singularity).
    ...
    # Delete last results
    for jobid in range(10, 16):
        rm_cmd = "rm -r " + output_dir + "/" + str(jobid)
