...
def perdikaris17_lofi(x, **kwargs):
    r"""Low-fidelity version of simple 1-d test function.
...
def perdikaris17_hifi(x, **kwargs):
    r"""High-fidelity version of simple 1-d test function.
