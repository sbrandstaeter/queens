...
def test_metropolis_hastings_multiple_chains_multivariate_gaussian(inputdir, tmp_path, dummy_data):
    ...
    template = inputdir.joinpath("metropolis_hastings_multiple_chains_multivariate_gaussian.yml")
    experimental_data_path = tmp_path
    dir_dict = {"experimental_data_path": experimental_data_path}
    input_file = tmp_path.joinpath(
        "multivariate_gaussian_metropolis_hastings_multiple_chains_realiz.yml"
    )
