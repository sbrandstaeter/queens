...
def test_bmfia_fourc_scatra_smc(inputdir, tmp_path, paths_dictionary):
    """Integration test for smc with a simple diffusion problem in fourc."""
    # generate yaml input file from template
    # template for actual smc evaluation
    template = inputdir / "bmfia_scatra_fourc_template_grid_gp_precompiled.yml"
